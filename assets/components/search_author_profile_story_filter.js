...
export default function SearchAuthorProfileStoryFilter ({data, input, navigation}) {
          ...
          if(input === "") {
              ...
              <View style={styles.content_container}>
                ...
                <View style={styles.content_buttons_container}>
                    <TouchableOpacity style={styles.comments_button} onPress={()=>navigation.navigate(ROUTES.SEARCHAUTHORPROFILESTORYCOMMENTS)}>
                      <Text style={styles.comments_button_text}> COMMENTS </Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.read_button} onPress={()=>navigation.navigate(ROUTES.SEARCHAUTHORPROFILESTORYCONTENTS)}>
